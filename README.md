...
The central scientific contribution is the **_equation-free identification_** of structural modes from operational sensor data and the reconstruction of failed or never-installed tower sensors from the remaining channels, demonstrated on a floating offshore wind turbine. Everything in this repository is organised around making that contribution reproducible by independent users.
